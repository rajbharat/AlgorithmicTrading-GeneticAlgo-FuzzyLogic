...
###############################################################################
#Bharat added dfFit and Cashstart
def fitness(ma, m, n, rsi, dfFit,cashstart,asset_bal):
    

    # Manually set df period for fitness calculation
    #dfFit = FCPO[str(yearstart):str(yearend)]  
    # # temporary df for calculating fitness
    #Bharat commented this
...
#    dfFit.head(50)
    ...
    fitnessValue = (dfFit['Asset'][len(dfFit)-1],dfFit)
